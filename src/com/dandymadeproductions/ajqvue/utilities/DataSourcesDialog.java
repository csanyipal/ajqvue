...
/**
 *    The DataSourcesDialog class provides a dialog to access
...
public class DataSourcesDialog extends JDialog implements ActionListener, PropertyChangeListener
{
   ...
   public DataSourcesDialog(JFrame frame, ConnectionProperties connectionProperties,
                                      boolean enableValidate)
   {
      ...
      resourceSuccess = resourceBundle.getResourceString(
         "DataSourcesDialog.message.Success", "Success");
